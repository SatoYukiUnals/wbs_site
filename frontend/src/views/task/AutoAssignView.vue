...
import { mockAutoAssignPreview } from '@/mocks/data'
...
const handlePreview = async () => {
  ...
  previewResults.value = [...mockAutoAssignPreview]
    ...
    >
      <div class="bg-white rounded-lg shadow-lg p-6 w-80">
        ...
        <div class="flex justify-end gap-2">
          <button class="px-4 py-2 text-sm border rounded hover:bg-gray-50" @click="showConfirmDialog = false">
            キャンセル
          </button>
          <button
