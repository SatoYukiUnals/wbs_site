...
<template>
  <div>
    ...
    <!-- ガントチャート本体 -->
    <div class="bg-white rounded-lg shadow overflow-x-auto overflow-y-auto max-h-[calc(100vh-220px)]">
